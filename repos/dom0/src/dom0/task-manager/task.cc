...
{
	PINF("Pausing task %s\n", _name.c_str());
	_meta->cpu.pause(_meta->child.main_thread_cap());
	Genode::Thread_state state = _meta->cpu.state(_meta->child.main_thread_cap());
	PDBG("Stack pointer: %d \n Register r0: %d \n Register r1: %d \n Register r2: %d \n Register r3: %d \n Register r4: %d \n Register r5: %d \n Register r6: %d \n Register r7: %d \n Register r8: %d \n Register r9: %d \n Register r10: %d \n Register r11: %d \n Register r12: %d", (int)state.sp, (int)state.r0, (int)state.r1, (int)state.r2, (int)state.r3, (int)state.r4, (int)state.r5, (int)state.r6, (int)state.r7, (int)state.r8, (int)state.r9, (int)state.r10, (int)state.r11, (int)state.r12);
}

void Task::resume()
{
	PINF("Resuming task %s\n", _name.c_str());
	_meta->cpu.resume(_meta->child.main_thread_cap());
}
